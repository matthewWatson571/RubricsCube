...
//                B1 + B2 + B3 + B4 + B5 + B6 + B7 + B8 + B9;
        ...
        String mixCube = "LLFRURLUUFBRBRRRLRDFLUFDDUDLLBFDBUFFBUBDLBRDFUFUDBLDRB"; //testing if you don't have a cube handy
        allCubiesAdded = 135;
...
//                yellow49Count + yellow50Count + yellow51Count + yellow52Count + yellow53Count);
        ...
        if (allCubiesAdded == 135){
            ...
            Toast.makeText(context, (getContext().getString(R.string.input_error) + allCubiesAdded), Toast.LENGTH_LONG).show();
        }
    }
}
