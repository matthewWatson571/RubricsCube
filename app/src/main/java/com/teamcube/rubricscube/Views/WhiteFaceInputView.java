...
public class WhiteFaceInputView extends LinearLayout {
    ...
    public void white01(){
        ...
        if(white18Count < 6){
            switch (white18Count){
                //orange
                case 0: white01.setBackgroundColor(Color.argb(255, 255, 149, 0));
                    U1 = "F";
                    break;
                //green
                case 1: white01.setBackgroundColor(Color.argb(255, 41, 198, 60));
                    U1 = "R";
                    break;
                //white
                case 2: white01.setBackgroundColor(Color.argb(255, 255, 255, 255));
                    U1 = "U";
                    break;
                //red
                case 3: white01.setBackgroundColor(Color.argb(255, 255, 40, 40));
                    U1 = "B";
                    break;
                //blue
                case 4: white01.setBackgroundColor(Color.argb(255, 0, 0, 255));
                    U1 = "L";
                    break;
                //yellow
                case 5: white01.setBackgroundColor(Color.argb(255, 246, 255, 0));
                    U1 = "D";
                    break;
            }
        } else {
    ...
    public void white02(){
        ...
        if(white19Count < 6){
            switch (white19Count){
                //orange
                case 0: white02.setBackgroundColor(Color.argb(255, 255, 149, 0));
                    U2 = "F";
                    break;
                //green
                case 1: white02.setBackgroundColor(Color.argb(255, 41, 198, 60));
                    U2 = "R";
                    break;
                //white
                case 2: white02.setBackgroundColor(Color.argb(255, 255, 255, 255));
                    U2 = "U";
                    break;
                //red
                case 3: white02.setBackgroundColor(Color.argb(255, 255, 40, 40));
                    U2 = "B";
                    break;
                //blue
                case 4: white02.setBackgroundColor(Color.argb(255, 0, 0, 255));
                    U2 = "L";
                    break;
                //yellow
                case 5: white02.setBackgroundColor(Color.argb(255, 246, 255, 0));
                    U2 = "D";
                    break;
            }
        } else {
    ...
    public void white03(){
        ...
        if(white20Count < 6){
            switch (white20Count){
                //orange
                case 0: white03.setBackgroundColor(Color.argb(255, 255, 149, 0));
                    U3 = "F";
                    break;
                //green
                case 1: white03.setBackgroundColor(Color.argb(255, 41, 198, 60));
                    U3 = "R";
                    break;
                //white
                case 2: white03.setBackgroundColor(Color.argb(255, 255, 255, 255));
                    U3 = "U";
                    break;
                //red
                case 3: white03.setBackgroundColor(Color.argb(255, 255, 40, 40));
                    U3 = "B";
                    break;
                //blue
                case 4: white03.setBackgroundColor(Color.argb(255, 0, 0, 255));
                    U3 = "L";
                    break;
                //yellow
                case 5: white03.setBackgroundColor(Color.argb(255, 246, 255, 0));
                    U3 = "D";
                    break;
            }
        } else {
    ...
    public void white04(){
        ...
        if(white21Count < 6){
            switch (white21Count){
                //orange
                case 0: white04.setBackgroundColor(Color.argb(255, 255, 149, 0));
                    U4 = "F";
                    break;
                //green
                case 1: white04.setBackgroundColor(Color.argb(255, 41, 198, 60));
                    U4 = "R";
                    break;
                //white
                case 2: white04.setBackgroundColor(Color.argb(255, 255, 255, 255));
                    U4 = "U";
                    break;
                //red
                case 3: white04.setBackgroundColor(Color.argb(255, 255, 40, 40));
                    U4 = "B";
                    break;
                //blue
                case 4: white04.setBackgroundColor(Color.argb(255, 0, 0, 255));
                    U4 = "L";
                    break;
                //yellow
                case 5: white04.setBackgroundColor(Color.argb(255, 246, 255, 0));
                    U4 = "D";
                    break;
            }
        } else {
    ...
    public void white06(){
        ...
        if(white23Count < 6){
            switch (white23Count){
                //orange
                case 0: white06.setBackgroundColor(Color.argb(255, 255, 149, 0));
                    U6 = "F";
                    break;
                //green
                case 1: white06.setBackgroundColor(Color.argb(255, 41, 198, 60));
                    U6 = "R";
                    break;
                //white
                case 2: white06.setBackgroundColor(Color.argb(255, 255, 255, 255));
                    U6 = "U";
                    break;
                //red
                case 3: white06.setBackgroundColor(Color.argb(255, 255, 40, 40));
                    U6 = "B";
                    break;
                //blue
                case 4: white06.setBackgroundColor(Color.argb(255, 0, 0, 255));
                    U6 = "L";
                    break;
                //yellow
                case 5: white06.setBackgroundColor(Color.argb(255, 246, 255, 0));
                    U6 = "D";
                    break;
            }
        } else {
    ...
    public void white07(){
        ...
        if(white24Count < 6){
            switch (white24Count){
                //orange
                case 0: white07.setBackgroundColor(Color.argb(255, 255, 149, 0));
                    U7 = "F";
                    break;
                //green
                case 1: white07.setBackgroundColor(Color.argb(255, 41, 198, 60));
                    U7 = "R";
                    break;
                //white
                case 2: white07.setBackgroundColor(Color.argb(255, 255, 255, 255));
                    U7 = "U";
                    break;
                //red
                case 3: white07.setBackgroundColor(Color.argb(255, 255, 40, 40));
                    U7 = "B";
                    break;
                //blue
                case 4: white07.setBackgroundColor(Color.argb(255, 0, 0, 255));
                    U7 = "L";
                    break;
                //yellow
                case 5: white07.setBackgroundColor(Color.argb(255, 246, 255, 0));
                    U7 = "D";
                    break;
            }
        } else {
    ...
    public void white08(){
        ...
        if(white25Count < 6){
            switch (white25Count){
                //orange
                case 0: white08.setBackgroundColor(Color.argb(255, 255, 149, 0));
                    U8 = "F";
                    break;
                //green
                case 1: white08.setBackgroundColor(Color.argb(255, 41, 198, 60));
                    U8 = "R";
                    break;
                //white
                case 2: white08.setBackgroundColor(Color.argb(255, 255, 255, 255));
                    U8 = "U";
                    break;
                //red
                case 3: white08.setBackgroundColor(Color.argb(255, 255, 40, 40));
                    U8 = "B";
                    break;
                //blue
                case 4: white08.setBackgroundColor(Color.argb(255, 0, 0, 255));
                    U8 = "L";
                    break;
                //yellow
                case 5: white08.setBackgroundColor(Color.argb(255, 246, 255, 0));
                    U8 = "D";
                    break;
            }
        } else {
    ...
    public void white09(){
        ...
        if(white26Count < 6){
            switch (white26Count){
                //orange
                case 0: white09.setBackgroundColor(Color.argb(255, 255, 149, 0));
                    U9 = "F";
                    break;
                //green
                case 1: white09.setBackgroundColor(Color.argb(255, 41, 198, 60));
                    U9 = "R";
                    break;
                //white
                case 2: white09.setBackgroundColor(Color.argb(255, 255, 255, 255));
                    U9 = "U";
                    break;
                //red
                case 3: white09.setBackgroundColor(Color.argb(255, 255, 40, 40));
                    U9 = "B";
                    break;
                //blue
                case 4: white09.setBackgroundColor(Color.argb(255, 0, 0, 255));
                    U9 = "L";
                    break;
                //yellow
                case 5: white09.setBackgroundColor(Color.argb(255, 246, 255, 0));
                    U9 = "D";
                    break;
            }
        } else {
